    ...
    <tbody style="white-space: nowrap;">
              ...
              <tr>
                                                           ...
                                                           <div class="row mb-12">
                                                            <div class="col-md-6">
                                                              <div class="form-group">
                                                                  ...
                                                                  <select id="myselection_due" class="browser-default custom-select myselection_due" name="status_id" required>
                ...
                @endif
                                              ...
                                              <script>
                                                $('.show_due').hide();
                                                $('.myselection_due').change(function() {
                                                $('.show_due').show();
                                              });
                                              </script>