...
?>
            {{-- <div class="modal fade edit_Myappeal" id="edit_Myappeal_{{ $appeal->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"> --}}
            ...
            <!-- </div> -->
                ...
                @endif
                        ...
                        <button type="button" class="btn btn-warning pull-right" data-dismiss="modal">Close</button>
                          {{ csrf_field() }}
                          <button type="submit" class="btn btn-success pull-right courts_submits" data-dismiss="modal" name="courts_submits" id="courts_submits" value="submit">Update</button>
