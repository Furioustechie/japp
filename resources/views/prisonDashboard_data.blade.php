                                                                        ...
                                                                        <form>
                                                                                    <ul class="stepper parallel horizontal">
                                                                                      <li class="step active">
                                                                                        <div class="step-title waves-effect waves-dark">BJ Form (Part 1)</div>
                                                                                        <div class="step-content">
                                                                                          <div class="row">
                                                                                             <div class='form-field'>
                                                                                                  
                                                                                              <p>Bangladesh Jal Form No. 5085</p>
                                                                                              <p><span>Bangaldesh Jail Form No. 27   Serial No:</span></p>
                                                                                              <p><span>(This part to be sen to the Sentencing Court)</span></p>
                                                                                              <p> <span>Petition for copy of Judgement of Order</span></p>
                                                                                             </div>
                                                                                             <div class='form-field col s12'>
                                                                                                 <div class="input-field col s4">
                                                                                                      <input type="text" name="nameofprisoner" class="required validate"/>
                                                                                                      <label for="textfield">Name of Prisoner</label>
                                                                                                    </div>
                                                                                                    <div class="input-field col s4">
                                                                                                      <input type="text" name="offence" class="required validate"/>
                                                                                                      <label for="textfield">Offence</label>
                                                                                                   </div>
                                                                                                         <div class="input-field col s4">
                                                                                                              <input type="text" name="sentence" class="required validate"/>
                                                                                                              <label for="textfield">Sentence</label>
                                                                                                            </div>
                                                                                                       <div class="input-field col s6">
                                                                                                            <label for="textfield">Date of Sentence</label>
                                                                                                              <input type="date" name="dateofsentence" class="required validate"/>
                                                                                                             
                                                                                                           </div>
                                                                                                           <div class="input-field col s6">
                                                                                                               <input type="text" name="sentencingAuthority" class="required validate"/>
                                                                                                               <label for="textfield">Sentencing Authority</label>
                                                                                                            </div>
                                                                                                               <p>** The abovenamed prisoner petitions for a copy of the judgement or order passes in his case.</p>
                                                                                      ...
                                                                                      <li class="step">
                                                                                        <div class="step-title waves-effect waves-dark">BJ Form (Part 2)</div>
                                                                                        <div class="step-content">
                                                                                          <div class="row">
                                                                                            <div class='form-field col s12'>
                                                                                      ...
                                                                                      <li class="step">
                                                                                        <div class="step-title waves-effect waves-dark">BJ Form (Part 3)</div>
                                                                                        <div class="step-content">
                                                                                          <div class="row">
                                                                                            <div class='form-field'>
                                                                                      ...
                                                                                      <li class="step">
                                                                                        <div class="step-title waves-effect waves-dark">Submission</div>
                                                                                        <div class="step-content">
                                                                                          <div class="row">
                                                                                            <div class='form-field'>
                                                                                              <p>Submit phase</p>
