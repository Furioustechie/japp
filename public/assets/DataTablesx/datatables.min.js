                ...
                if (n)
                    if (d.isArray(n)) this._expandButton(a, n, c, e);
                        ...
                        if (t) {
                            ...
                            n.init &&
                                n.init.call(f.button(t.node), f, d(t.node), n);
                            h++;
                        }
                    }
            }
                ...
                f = function (a, b) {
                    ...
                    if (d.isArray(a) || a instanceof d)
                        ...
                        if (-1 !== a.indexOf(","))
                            ...
                            for (
                                a = a.replace(":name", ""), g = 0, k = h.length;
                                g < k;
                                g++
                            )
                                h[g].name === a &&
    ...
    d.extend(q, {
        collection: {
            ...
            action: function (a, b, c, e) {
                ...
                e.background &&
                    r.background(!0, e.backgroundClassName, e.fade, g);
                var l = function () {
