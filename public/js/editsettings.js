...
$(".submit-sentence").click(function (e) {
    ...
    var name = $("#edit_sentenceName")
        .find("input[name='rename_sentence']")
        .val();
...
$(".submit-offence").click(function (e) {
    ...
    var name = $("#edit_offenceName")
        .find("input[name='rename_offence']")
        .val();
...
/* Edit Prisons Item */ $("body").on("click", ".edit_statusName", function () {
    var id = $(this).data("id");
    /* var name = $(this).parent("td").prev("td").prev("td").text();*/
    var name = $(this).parent("td").prev("td").prev("td").text();
    ...
    $("#edit_statusName")
        .find("input[name='rename_expire_in_days']")
        .val(expire_in_days);
...
$(".submit-status").click(function (e) {
    ...
    var expire_in_days = $("#edit_statusName")
        .find("input[name='rename_expire_in_days']")
        .val();
        ...
        columnDefs: [
            {
                render: function (data, type, row) {
                    return data === 0
                        ...
                        : '<span class="text-warning"><i class="material-icons">lock</i></span>';
                },
                targets: 4,
            },
        ],
...
/* Edit Prisons Item */ $("body").on("click", ".edit_accountName", function () {
    var id = $(this).data("id");
    var name = $(this)
        .parent("td")
        .prev("td")
...
$(".submit-accountName").click(function (e) {
    ...
    var email = $("#edit_accountName")
        .find("input[name='rename_emailid']")
        .val();
